...
module.exports = "<ul *ngIf=\"type == 'header'\" class=\"navbar-nav   ul_icons\">\n  <li class=\"nav-item li_icons instgram_icon_\">\n    <a *ngIf=\"instaUrl != undefined\" (click)=\"onNavigate(instaUrl)\">\n      <!--    <i class=\"fab fa-instagram icons\"></i>-->\n      <img src=\"assets/imgs/instgram.png\" style=\"    border-radius: 5px;\nmargin-bottom: 4px;\nwidth: 85%;\" />\n    </a>\n  </li>\n  <li class=\"nav-item li_icons\">\n    <a *ngIf=\"youtubeUrl != undefined\" (click)=\"onNavigate(youtubeUrl)\">\n      <!--   <i class=\"fab fa-youtube icons\"></i>-->\n      <img src=\"assets/imgs/youtube.jpg\" style=\"      border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 10px;\nwidth: 59%;\" />\n    </a>\n  </li>\n\n  <li class=\"nav-item li_icons\">\n    <!--     <i class=\"fab fa-twitter-square icons\"></i>-->\n    <a *ngIf=\"twitterUrl != undefined\" (click)=\"onNavigate(twitterUrl)\">\n      <img src=\"assets/imgs/twiiter.png\" style=\"    border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 10px;\nwidth: 55%;\" />\n    </a>\n  </li>\n\n  <li class=\"nav-item li_icons\">\n    <!--     <i class=\"fab fa-facebook-square icons\"></i>-->\n    <a *ngIf=\"fbUrl != undefined\" (click)=\"onNavigate(fbUrl)\">\n      <img src=\"assets/imgs/facebook.png\" style=\"        border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 10px;\nwidth: 60%;\" />\n    </a>\n  </li>\n\n  <li class=\"nav-item li_icons search_icon_\">\n    <a routerLink=\"/search\">\n      <!--    <i class=\"fas fa-search icons\"></i>-->\n      <img src=\"assets/imgs/search.png\" style=\"      border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 30px;\nwidth: 39%;\" />\n    </a>\n  </li>\n</ul>\n\n<ul *ngIf=\"type == 'header1'\" class=\"navbar-nav   ul_icons\">\n  <li class=\"nav-item li_icons instgram_icon_\">\n    <a *ngIf=\"instaUrl != undefined\" (click)=\"onNavigate(instaUrl)\">\n      <!--    <i class=\"fab fa-instagram icons\"></i>-->\n      <img src=\"assets/imgs/instgram.png\" style=\"    border-radius: 5px;\nmargin-bottom: 4px;\nwidth: 85%;\" />\n    </a>\n  </li>\n  <li class=\"nav-item li_icons\">\n    <a *ngIf=\"youtubeUrl != undefined\" (click)=\"onNavigate(youtubeUrl)\">\n      <!--   <i class=\"fab fa-youtube icons\"></i>-->\n      <img src=\"assets/imgs/youtube.jpg\" style=\"      border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 10px;\nwidth: 59%;\" />\n    </a>\n  </li>\n\n  <li class=\"nav-item li_icons\">\n    <!--     <i class=\"fab fa-twitter-square icons\"></i>-->\n    <a *ngIf=\"twitterUrl != undefined\" (click)=\"onNavigate(twitterUrl)\">\n      <img src=\"assets/imgs/twiiter.png\" style=\"    border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 10px;\nwidth: 55%;\" />\n    </a>\n  </li>\n\n  <li class=\"nav-item li_icons\">\n    <!--     <i class=\"fab fa-facebook-square icons\"></i>-->\n    <a *ngIf=\"fbUrl != undefined\" (click)=\"onNavigate(fbUrl)\">\n      <img src=\"assets/imgs/facebook.png\" style=\"        border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 10px;\nwidth: 60%;\" />\n    </a>\n  </li>\n\n  <li class=\"nav-item li_icons search_icon_\">\n    <a routerLink=\"/search\">\n      <!--    <i class=\"fas fa-search icons\"></i>-->\n      <img src=\"assets/imgs/search_red.png\" style=\"      border-radius: 3px;\nmargin-bottom: 4px;\nmargin-right: 30px;\nwidth: 39%;\" />\n    </a>\n  </li>\n</ul>\n\n<div *ngIf=\"type == 'footer'\">\n  <img *ngIf=\"fbUrl != undefined\" (click)=\"onNavigate(fbUrl)\" src=\"assets/imgs/facebook.png\" />\n  <img *ngIf=\"twitterUrl != undefined\" (click)=\"onNavigate(twitterUrl)\" src=\"assets/imgs/twiiter.png\" />\n  <img *ngIf=\"youtubeUrl != undefined\" (click)=\"onNavigate(youtubeUrl)\" src=\"assets/imgs/youtube.jpg\" />\n  <img *ngIf=\"instaUrl != undefined\" (click)=\"onNavigate(instaUrl)\" src=\"assets/imgs/instgram.png\" />\n</div>\n"
...
var ArticlesComponent = /** @class */ (function () {
    ...
    ArticlesComponent.prototype.getSharingLink = function (articleId) {
        return src_app_Constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].SHARING_URL + "/articleDetails/article/" + articleId;
    };
...
var HomePageComponent = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        params2 = { "part": "snippet,contentDetails", "maxResults": "1", "playlistId": this.newsProgram.playlistUrl, "key": src_app_Constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].YOUTUBE_API_KEY };
    ...
    HomePageComponent.prototype.translateDate = function (date) {
        moment__WEBPACK_IMPORTED_MODULE_5__["locale"]('ar');
...
module.exports = "<div class=\"contain\">\n  <nav class=\"navbar navbar-expand-lg     navbar-inverse\" dir=\"rtl\">\n    <a class=\"navbar-brand\" routerLink=\"/\"\n      ><img src=\"assets/imgs/logo.png\" class=\"logo\"\n    /></a>\n    <button\n      class=\"navbar-toggler\"\n      type=\"button\"\n      data-toggle=\"collapse\"\n      data-target=\"#navbarSupportedContent\"\n      aria-controls=\"navbarSupportedContent\"\n      aria-expanded=\"false\"\n      aria-label=\"Toggle navigation\"\n    >\n      <span class=\"navbar-toggler-icon\">\n        <i class=\"fas fa-bars bar\" aria-hidden=\"true\"></i>\n      </span>\n    </button>\n\n    <div class=\"collapse navbar-collapse  \" id=\"navbarSupportedContent\">\n      <ul class=\"navbar-nav   links\">\n        <li class=\"nav-item\">\n          <a class=\"nav-link \" routerLink=\"/\"\n            >الرئيسية <span class=\"sr-only\">(current)</span></a\n          >\n        </li>\n        <li class=\"nav-item active\">\n          <a class=\"nav-link\" routerLink=\"/live\">البث المباشر</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link lead\" routerLink=\"/schedule\">جدول البرامج</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/programs\">برامجنا</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/articles\">آخر الأخبار</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/sports\">رياضة</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/video\">فيديو</a>\n        </li>\n      </ul>\n      <app-social-media-icons type=\"header\"></app-social-media-icons>\n    </div>\n  </nav>\n\n  <main role=\"main\">\n    <div class=\"contained\">\n      <div class=\"video\">\n        <div class=\"row live_broadcast_row\">\n          <div class=\"col-lg-3 d-none d-lg-block  \tads_col\">\n            <!-- <img src=\"assets/imgs/sale1.jpg\" class=\"ads float-right\" style=\"margin-right: 12.5%;\" /> -->\n          </div>\n\n          <div class=\"col-lg-6 col-md-12\">\n            <div class=\"live_broadcast\">\n              <iframe\n                class=\"new_img2 img-responsive  iframe\"\n                allowfullscreen=\"true\"\n                frameborder=\"0\"\n                height=\"100%\"\n                width=\"120%\"\n                src=\"https://firebasestorage.googleapis.com/v0/b/wtvproject-f33c2.appspot.com/o/index_kwik.html?alt=media&token=6b43d90d-fb26-46ec-9ee3-1493738c671b\"\n              >\n              </iframe>\n              <!-- <app-live-stream-link class=\"new_img2 img-responsive\" style=\"height:100%; width:120%\"></app-live-stream-link> -->\n              <!-- <youtube-player\n                *ngIf=\"settings != undefined\"\n                class=\"new_img2 img-responsive\"\n                height=\"100%\"\n                width=\"120%\"\n                [videoId]=\"settings.liveUrl\"\n              ></youtube-player> -->\n            </div>\n          </div>\n\n          <div class=\"col-lg-3 d-none d-lg-block  ads_col\">\n            <!-- <img src=\"assets/imgs/sale1.jpg\" class=\"ads float-left\" style=\"margin-left: 12.5%;\" /> -->\n          </div>\n        </div>\n        <div class=\"row\">\n          <div\n            class=\"col-lg-12 col-xs-12 live_broadcast_text\"\n            style=\"text-align: center\"\n          >\n            <h6 style=\"font-weight: bold;\">البث المباشر للقناة</h6>\n            <!-- <p style=\"    font-size: small;\n    color: #ccc;\">\n              عدد المشاهدات\n            </p>\n            <p style=\"    font-size: small;\n    color: #ccc;\">\n              {{ viewsCount }}\n            </p> -->\n          </div>\n        </div>\n      </div>\n\n      <!-- Fooooterrrrrrrrrrr  -->\n\n      <div class=\"footer\">\n        <div class=\"row\">\n          <div class=\"col-lg-6 col-md-6 col-sm-6  col-xs-12 footer_apps\">\n            <app-mobile-apps-icons></app-mobile-apps-icons>\n          </div>\n\n          <div\n            class=\"col-lg-5  offest-lg-8 col-md-6  col-sm-6 col-xs-12 footer_map\"\n          >\n            <div>\n              <p>خريطه الموقع</p>\n              <p>\n                <a routerLink=\"/\">الرئيسية</a>\n                <a routerLink=\"/live\" class=\"active\">البث&nbsp;المباشر</a>\n                <a routerLink=\"/schedule\">جدول&nbsp;البرامج</a>\n                <a routerLink=\"/programs\">برامجنا</a>\n                <a routerLink=\"/articles\">آخر الأخبار</a>\n\n                <a routerLink=\"/sports\">رياضة</a>\n                <a routerLink=\"/video\">فيديو</a>\n                <a routerLink=\"/aboutUs\">عن&nbsp;الوسط</a>\n                <a routerLink=\"/contactUs\">تواصل&nbsp;معنا</a>\n                <a routerLink=\"/team\">الفريق</a\n                ><a routerLink=\"/privacy\">الخصوصية</a>\n                <a routerLink=\"/terms\">شروط الاستخدام</a>\n              </p>\n            </div>\n          </div>\n          <hr />\n        </div>\n        <div class=\"row footer_row_p2\">\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-12  footer_icons\">\n            <app-social-media-icons type=\"footer\"></app-social-media-icons>\n          </div>\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-12  footer_dev\">\n            DEVELOPED BY: LIBYANA MEDIA PRODUCTION\n          </div>\n          <div class=\"col-lg-4   col-md-4  col-sm-4 col-xs-12  footer_copy\">\n            <p>جميع الحقوق الملكية تابعة لشبكة الوسط</p>\n          </div>\n        </div>\n\n        <span class=\"clearfix\"></span>\n\n        <div\n          class=\"col-lg-12  col-md-12  col-xs-12  \"\n          style=\"text-align: center\"\n        ></div>\n      </div>\n    </div>\n  </main>\n</div>\n"
...
var ProgramsScheduleComponent = /** @class */ (function () {
    ...
    ProgramsScheduleComponent.prototype.ngOnInit = function () {
        moment__WEBPACK_IMPORTED_MODULE_2__["locale"]('en');
    ...
    ProgramsScheduleComponent.prototype.getPublishTime = function (time) {
        ...
        return time ? moment__WEBPACK_IMPORTED_MODULE_2__["utc"](time).format("hh:mm a") : "";
        // return time;
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        // console.log(today);
                        _b = this;
                        return [4 /*yield*/, this.scheduleService.getCurrentAndUpcoming(moment__WEBPACK_IMPORTED_MODULE_2__().toString().substr(0, 3), this.getNowTime(today), moment__WEBPACK_IMPORTED_MODULE_2__(today).format("YYYY-MM-DD"))];
                    case 2:
                        // console.log(today);
...
var ProgramsComponent = /** @class */ (function () {
    ...
    ProgramsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_uiServices_programs_service__WEBPACK_IMPORTED_MODULE_1__["ProgramsService"], src_app_services_uiServices_home_page_services_service__WEBPACK_IMPORTED_MODULE_2__["HomePageServicesService"]])
    ], ProgramsComponent);
...
module.exports = "<div class=\"contain\">\n  <nav class=\"navbar navbar-expand-lg     navbar-inverse\" dir=\"rtl\">\n    <a class=\"navbar-brand\" routerLink=\"/\"><img src=\"assets/imgs/logo.png\" class=\"logo\" /></a>\n    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\"\n      aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\">\n        <i class=\"fas fa-bars bar\" aria-hidden=\"true\"></i>\n      </span>\n    </button>\n\n    <div class=\"collapse navbar-collapse  \" id=\"navbarSupportedContent\">\n      <ul class=\"navbar-nav   links\">\n        <li class=\"nav-item\">\n          <a class=\"nav-link \" routerLink=\"/\">الرئيسية <span class=\"sr-only\">(current)</span></a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/live\">البث المباشر</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link lead\" routerLink=\"/schedule\">جدول البرامج</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/programs\">برامجنا</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/articles\">آخر الأخبار</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/sports\">رياضة</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/video\">فيديو</a>\n        </li>\n      </ul>\n      <app-social-media-icons type=\"header1\"> </app-social-media-icons>\n    </div>\n  </nav>\n\n  <main role=\"main\">\n    <div class=\"contained\">\n      <div class=\"video\">\n        <div class=\"search_bar row\">\n          <div class=\"col-lg-8 col-md-8 col-sm-8  col-xs-8 search_bar_block1\">\n            <img src=\"assets/imgs/search.png\" /><input type=\"text\" [(ngModel)]=\"searchKeyword\" class=\"text_field_search\"\n              placeholder=\"ما الذي تبحث عنه؟\" />\n          </div>\n\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-4 search_bar_block2\">\n            <button (click)=\"search()\" class=\"btn btn_search\">\n              بحث\n            </button>\n          </div>\n        </div>\n        <div class=\"row Program_Schedule_row search_page\">\n          <div class=\"col-lg-3 d-none d-lg-block  \tads_col\">\n            <!-- <img src=\"assets/imgs/sale1.jpg\" class=\"ads float-right\" style=\"margin-right: 12.5%;\" /> -->\n          </div>\n\n          <div class=\"col-lg-6 col-md-12 main_\">\n\n            <div class=\"Program_Schedule\">\n              <div class=\" mixtup_container_controls mixtup_container_controls_search\">\n                <div class=\"controls controls_search\">\n                  <!-- <button class=\"filter \" data-filter=\".Sub\">الآخر الأخبار</button>\n                  <button class=\"filter\" data-filter=\".Ved\">فيديو</button> -->\n                  <button [ngClass]=\"{'red-text' : !showVideos, 'white-text': showVideos}\" class=\"filter \"\n                    (click)=\"displayVideos(false)\">آخر الأخبار</button>\n                  <button [ngClass]=\"{'red-text' : showVideos, 'white-text': !showVideos}\" class=\"filter\"\n                    (click)=\"displayVideos(true)\">فيديو</button>\n                </div>\n              </div>\n\n              <div class=\" mixtup_container_rows\">\n                <h3 style=\"text-align: center;\"\n                  *ngIf=\"(articles != undefined && articles.length == 0) && (vidoes != undefined && vidoes.length == 0)\">\n                  لا توجد نتائج للبحث\n                </h3>\n                <div id=\"Container\" class=\"container\">\n                  <!-- <div *ngIf=\"!showVideos\"> -->\n                  <div class=\"mix  Sub  Subjects_box Subjects_box_search\"\n                    [ngClass]=\"{'display' : !showVideos, 'hide': showVideos}\" *ngFor=\"let article of articles\">\n                    <div class=\"row Subjects_box_search_row\">\n                      <div class=\"col-lg-9 col-md-8 col-xs-12\">\n                        <span class=\"share_icons\">\n                          <share-button button=\"facebook\" [url]=\"\n                              getSharingLink(\n                                article.id,\n                                article.type == null ? 'sports' : 'article'\n                              )\n                            \"></share-button>\n                          <share-button button=\"twitter\" [url]=\"\n                              getSharingLink(\n                                article.id,\n                                article.type == null ? 'sports' : 'article'\n                              )\n                            \"></share-button>\n                          <p class=\"share_word\">:مشاركة</p>\n                        </span>\n                        <a routerLink=\"/articleDetails/{{\n                            article.type == null ? 'sports' : 'article'\n                          }}/{{ article.id }}\">\n                          {{ article.name }}\n                        </a>\n                        <h6>{{ article.publishDate | date }}</h6>\n                        <p [innerHTML]=\"article.article\"></p>\n                      </div>\n                      <div class=\"col-lg-3 col-md-4 col-xs-12\">\n                        <a routerLink=\"/articleDetails/{{\n                            article.type == null ? 'sports' : 'article'\n                          }}/{{ article.id }}\">\n                          <img src=\"{{ article.images[0] }}\" class=\"new_img2 img-responsive\" />\n                        </a>\n                      </div>\n                    </div>\n                  </div>\n                  <div *ngIf=\"articles && articles.length != 0\"\n                    [ngClass]=\"{'display' : !showVideos, 'hide': showVideos}\"\n                    style=\"text-align: center;margin-top: 8px;\">\n                    <button (click)=\"loadMore()\" class=\"btn\">\n                      المزيد\n                    </button>\n                  </div>\n                  <!-- </div> -->\n\n                  <!-- <div *ngIf=\"showVideos\"> -->\n                  <div [ngClass]=\"{'display' : showVideos, 'hide': !showVideos}\"\n                    class=\"mix Ved col-lg-4 col-md-4 col-xs-12 videos_box videos_box_serach \"\n                    *ngFor=\"let item of vidoes\">\n                    <a>\n                      <youtube-player class=\"new_img2 img-responsive\" height=\"131\" width=\"90%\"\n                        [videoId]=\"item.id.videoId\"></youtube-player>\n                      <div class=\"OurProgram_desciption videos Program_Schedule2_text\">\n                        <h5>{{ translateDate(item.snippet.publishedAt) }}</h5>\n                        <p>{{ item.snippet.title }}</p>\n                      </div>\n                    </a>\n                  </div>\n                  <!-- </div> -->\n                </div>\n              </div>\n            </div>\n          </div>\n          <div class=\"col-lg-3 d-none d-lg-block  ads_col\">\n            <!-- <img src=\"assets/imgs/sale1.jpg\" class=\"ads float-left\" style=\"margin-left: 12.5%;\" /> -->\n          </div>\n        </div>\n      </div>\n\n      <!-- Fooooterrrrrrrrrrr  -->\n\n      <div class=\"footer\">\n        <div class=\"row\">\n          <div class=\"col-lg-6 col-md-6 col-sm-6  col-xs-12 footer_apps\">\n            <app-mobile-apps-icons></app-mobile-apps-icons>\n          </div>\n\n          <div class=\"col-lg-5  offest-lg-8 col-md-6  col-sm-6 col-xs-12 footer_map\">\n            <div>\n              <p>خريطه الموقع</p>\n              <p>\n                <a routerLink=\"/\">الرئيسية</a>\n                <a routerLink=\"/live\">البث&nbsp;المباشر</a>\n                <a routerLink=\"/schedule\">جدول&nbsp;البرامج</a>\n                <a routerLink=\"/programs\">برامجنا</a>\n                <a routerLink=\"/articles\">آخر الأخبار</a>\n\n                <a routerLink=\"/sports\">رياضة</a>\n                <a routerLink=\"/video\">فيديو</a>\n                <a routerLink=\"/aboutUs\">عن&nbsp;الوسط</a>\n                <a routerLink=\"/contactUs\">تواصل&nbsp;معنا</a>\n                <a routerLink=\"/team\">الفريق</a><a routerLink=\"/privacy\">الخصوصية</a>\n                <a routerLink=\"/terms\">شروط الاستخدام</a>\n              </p>\n            </div>\n          </div>\n          <hr />\n        </div>\n        <div class=\"row footer_row_p2\">\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-12  footer_icons\">\n            <app-social-media-icons type=\"footer\"></app-social-media-icons>\n          </div>\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-12  footer_dev\">\n            DEVELOPED BY: LIBYANA MEDIA PRODUCTION\n          </div>\n          <div class=\"col-lg-4   col-md-4  col-sm-4 col-xs-12  footer_copy\">\n            <p>جميع الحقوق الملكية تابعة لشبكة الوسط</p>\n          </div>\n        </div>\n\n        <span class=\"clearfix\"></span>\n\n        <div class=\"col-lg-12  col-md-12  col-xs-12  \" style=\"text-align: center\"></div>\n      </div>\n    </div>\n  </main>\n</div>"
...
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm5/platform-browser.js");
/* harmony import */ var src_app_Constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/Constants */ "./src/app/Constants.ts");
/* harmony import */ var src_app_services_service_handler_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/service-handler.service */ "./src/app/services/service-handler.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.displayVideos = function (displayVid) {
        this.showVideos = displayVid;
    };
    SearchComponent.prototype.loadMore = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.articlesCount = this.articlesCount + 5;
                this.articles = this.originalArticles.slice(0, this.articlesCount);
                return [2 /*return*/];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.originalArticles = _b.sent();
                        this.originalArticles = this.originalArticles.map(function (article) {
                            var newArticle = article;
                            newArticle.article = _this.sanitizer.bypassSecurityTrustHtml(article.article);
                            return newArticle;
                        });
    ...
    SearchComponent.prototype.getSharingLink = function (articleId, articleType) {
        return src_app_Constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].SHARING_URL + "/articleDetails/" + articleType + "/" + articleId;
    };
    ...
    SearchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_uiServices_home_page_services_service__WEBPACK_IMPORTED_MODULE_2__["HomePageServicesService"],
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"],
            src_app_services_service_handler_service__WEBPACK_IMPORTED_MODULE_5__["ServiceHandlerProvider"]])
    ], SearchComponent);
...
var SportsComponent = /** @class */ (function () {
    ...
    SportsComponent.prototype.getSharingLink = function (articleId) {
        return src_app_Constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].SHARING_URL + "/articleDetails/sports/" + articleId;
    };
...
/***/ "./src/app/pages/team-detail/team-detail.component.css":
/*!*************************************************************!*\
  !*** ./src/app/pages/team-detail/team-detail.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"contain\">\n  <nav class=\"navbar navbar-expand-lg     navbar-inverse\" dir=\"rtl\">\n    <a class=\"navbar-brand\" routerLink=\"/\"\n      ><img src=\"assets/imgs/logo.png\" class=\"logo\"\n    /></a>\n    <button\n      class=\"navbar-toggler\"\n      type=\"button\"\n      data-toggle=\"collapse\"\n      data-target=\"#navbarSupportedContent\"\n      aria-controls=\"navbarSupportedContent\"\n      aria-expanded=\"false\"\n      aria-label=\"Toggle navigation\"\n    >\n      <span class=\"navbar-toggler-icon\">\n        <i class=\"fas fa-bars bar\" aria-hidden=\"true\"></i>\n      </span>\n    </button>\n\n    <div class=\"collapse navbar-collapse  \" id=\"navbarSupportedContent\">\n      <ul class=\"navbar-nav   links\">\n        <li class=\"nav-item\">\n          <a class=\"nav-link \" routerLink=\"/\"\n            >الرئيسية <span class=\"sr-only\">(current)</span></a\n          >\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/live\">البث المباشر</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link lead\" routerLink=\"/schedule\">جدول البرامج</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/programs\">برامجنا</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/articles\">آخر الأخبار</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/sports\">رياضة</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" routerLink=\"/video\">فيديو</a>\n        </li>\n      </ul>\n      <app-social-media-icons type=\"header\"></app-social-media-icons>\n    </div>\n  </nav>\n\n  <main role=\"main\">\n    <div class=\"contained\">\n      <div class=\"video\">\n        <div class=\"row OurProgram_row videos_row team_row team_detail_row\">\n          <div class=\"col-lg-3 d-none d-lg-block  \tads_col\">\n            <!-- <img\n              src=\"assets/imgs/sale1.jpg\"\n              class=\"ads float-right\"\n              style=\"margin-right: 12.5%;\"\n            /> -->\n          </div>\n\n          <div class=\"col-lg-6 col-md-12 OurProgram team_detail\">\n            <div class=\"row special\">\n              <!-- <div class=\"row \" *ngIf=\"selectedMember != undefined\">\n              <div class=\"col-lg-6 col-md-12  member_img_col\">\n                <img\n                  src=\"{{ selectedMember.image }}\"\n                  class=\"  img-responsive member_img\"\n                />\n              </div>\n              <div class=\"col-lg-6 col-md-12 member_detail_col\">\n                <p style=\"text-align:right\"><b>الاسم :</b></p>\n                <p>{{ selectedMember.name }}</p>\n                <p style=\"text-align:right\"><b>الوظيفة :</b></p>\n                <p>{{ selectedMember.position }}</p>\n                <p style=\"text-align:right\">\n                  <b>السيرة الذاتية :</b>\n                </p>\n                <p>{{ selectedMember.cv }}</p>\n              </div>\n            </div> -->\n              <div\n                style=\"text-align: center;     margin: auto;\"\n                *ngIf=\"selectedMember != undefined\"\n              >\n                <img\n                  src=\"{{ selectedMember.image }}\"\n                  class=\"  img-responsive member_img\"\n                />\n                <br /><br />\n                <p><b>الاسم :</b> {{ selectedMember.name }}</p>\n\n                <p><b> الوظيفة : </b>{{ selectedMember.position }}</p>\n\n                <p>\n                  <b>: السيرة الذاتية</b>\n                </p>\n                <p>{{ selectedMember.cv }}</p>\n              </div>\n            </div>\n          </div>\n          <div class=\"col-lg-3 d-none d-lg-block  ads_col\">\n            <!-- <img\n              src=\"assets/imgs/sale1.jpg\"\n              class=\"ads float-left\"\n              style=\"margin-left: 12.5%;\"\n            /> -->\n          </div>\n        </div>\n      </div>\n\n      <!-- Fooooterrrrrrrrrrr  -->\n\n      <div class=\"footer\">\n        <div class=\"row\">\n          <div class=\"col-lg-6 col-md-6 col-sm-6  col-xs-12 footer_apps\">\n            <app-mobile-apps-icons></app-mobile-apps-icons>\n          </div>\n\n          <div\n            class=\"col-lg-5  offest-lg-8 col-md-6  col-sm-6 col-xs-12 footer_map\"\n          >\n            <div>\n              <p>خريطه الموقع</p>\n              <p>\n                <a routerLink=\"/\">الرئيسية</a>\n                <a routerLink=\"/live\">البث&nbsp;المباشر</a>\n                <a routerLink=\"/schedule\">جدول&nbsp;البرامج</a>\n                <a routerLink=\"/programs\">برامجنا</a>\n                <a routerLink=\"/articles\">آخر الأخبار</a>\n\n                <a routerLink=\"/sports\">رياضة</a>\n                <a routerLink=\"/video\">فيديو</a>\n                <a routerLink=\"/aboutUs\">عن&nbsp;الوسط</a>\n                <a routerLink=\"/contactUs\">تواصل&nbsp;معنا</a>\n                <a routerLink=\"/team\" class=\"active\">الفريق</a\n                ><a routerLink=\"/privacy\">الخصوصية</a>\n                <a routerLink=\"/terms\">شروط الاستخدام</a>\n              </p>\n            </div>\n          </div>\n          <hr />\n        </div>\n        <div class=\"row footer_row_p2\">\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-12  footer_icons\">\n            <app-social-media-icons type=\"footer\"></app-social-media-icons>\n          </div>\n          <div class=\"col-lg-4 col-md-4 col-sm-4  col-xs-12  footer_dev\">\n            DEVELOPED BY: LIBYANA MEDIA PRODUCTION\n          </div>\n          <div class=\"col-lg-4   col-md-4  col-sm-4 col-xs-12  footer_copy\">\n            <p>جميع الحقوق الملكية تابعة لشبكة الوسط</p>\n          </div>\n        </div>\n\n        <span class=\"clearfix\"></span>\n\n        <div\n          class=\"col-lg-12  col-md-12  col-xs-12  \"\n          style=\"text-align: center\"\n        ></div>\n      </div>\n    </div>\n  </main>\n</div>\n"
...
var TeamDetailComponent = /** @class */ (function () {
    ...
    TeamDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./team-detail.component.html */ "./src/app/pages/team-detail/team-detail.component.html"),
            styles: [__webpack_require__(/*! ./team-detail.component.css */ "./src/app/pages/team-detail/team-detail.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_uiServices_home_page_services_service__WEBPACK_IMPORTED_MODULE_1__["HomePageServicesService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], TeamDetailComponent);
...
var VideoComponent = /** @class */ (function () {
    ...
    VideoComponent.prototype.translateDate = function (date) {
        moment__WEBPACK_IMPORTED_MODULE_4__["locale"]('ar');
...
module.exports = __webpack_require__(/*! /Users/a/Work/WTV/tvclient/src/main.ts */"./src/main.ts");
