...
var HomePageComponent = /** @class */ (function () {
    function HomePageComponent(homeService, serviceHandeler, articlesService, scheduleService) {
        this.homeService = homeService;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        params = { "part": "snippet,contentDetails", "maxResults": "6", "playlistId": this.videosUrl, "key": src_app_Constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].YOUTUBE_API_KEY };
                        this.serviceHandeler.runService("https://www.googleapis.com/youtube/v3/playlistItems", "GET", null, null, null, params).subscribe(function (response) {
                            ...
                            _this.lastVideoItem = _this.programYoutubeVideos[(_this.programYoutubeVideos.length - 1)];
                            console.log("Last item");
                            console.log(_this.lastVideoItem);
                        }, function (error) {
                            console.log(error);
                        });
    ...
    HomePageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_uiServices_home_page_services_service__WEBPACK_IMPORTED_MODULE_3__["HomePageServicesService"], src_app_services_service_handler_service__WEBPACK_IMPORTED_MODULE_2__["ServiceHandlerProvider"], src_app_services_uiServices_articles_service__WEBPACK_IMPORTED_MODULE_4__["ArticlesService"], src_app_services_uiServices_schedule_service__WEBPACK_IMPORTED_MODULE_6__["ScheduleService"]])
    ], HomePageComponent);
...
var ProgramsScheduleComponent = /** @class */ (function () {
    function ProgramsScheduleComponent(scheduleService, homeService) {
        this.scheduleService = scheduleService;
        this.homeService = homeService;
        this.weekSchedule = {
            sat: [],
    ...
    ProgramsScheduleComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_uiServices_schedule_service__WEBPACK_IMPORTED_MODULE_1__["ScheduleService"], src_app_services_uiServices_home_page_services_service__WEBPACK_IMPORTED_MODULE_3__["HomePageServicesService"]])
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.serviceHadler.runService(src_app_Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].BASE_URL, "POST", null, { "query": query }).subscribe(function (response) {
                            ...
                            if (response.data && response.data.daySchedules) {
                                ...
                                daySchedules = daySchedules.filter(function (item) { return item.program != null && item.program.isShowen; });
