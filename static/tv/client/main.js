            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (this.specialPrograms[0]) {
                            this.getProgramsVideos(this.specialPrograms[0].playlistUrl, 1);
                        }
                        if (this.specialPrograms[1]) {
                            this.getProgramsVideos(this.specialPrograms[1].playlistUrl, 2);
                        }
                        if (this.specialPrograms[2]) {
                            this.getProgramsVideos(this.specialPrograms[2].playlistUrl, 3);
                        }
                        if (this.specialPrograms[3]) {
                            this.getProgramsVideos(this.specialPrograms[3].playlistUrl, 4);
                        }
                        if (this.specialPrograms[4]) {
                            this.getProgramsVideos(this.specialPrograms[4].playlistUrl, 5);
                        }
                        if (this.specialPrograms[5]) {
                            this.getProgramsVideos(this.specialPrograms[5].playlistUrl, 6);
                        }
                        return [2 /*return*/];
                }
            });
